...
DefaultMap="zs-dvorak-default lcdFuncMap"
...
PartialMaps[1]="zs-f-keys"
PartialMaps[2]="zs-numpad"
PartialMaps[3]="zs-qwerty"
PartialMaps[4]="zs-symbols"
PartialMaps[5]="zs-game"
